<div class="p-6 sm:px-20 bg-white border-b border-gray">
    <div>
...
<div class="bg-gray bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
    <div class="p-6">
    ...
    <div class="p-6 border-t border-gray md:border-t-0 md:border-l">
        <div class="flex items-center">
    ...
    <div class="p-6 border-t border-gray">
        <div class="flex items-center">
    ...
    <div class="p-6 border-t border-gray md:border-l">
        <div class="flex items-center">
