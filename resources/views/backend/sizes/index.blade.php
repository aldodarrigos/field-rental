                ...
                <div class="ibox ">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            <a href="/sizes/create" class="btn btn-primary btn-xs">New Size</a>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                @foreach ($records as $record)
                                    ...
                                    <tr class="gradeX">
                                        <td><a href="/sizes/{{$record->id}}/edit">{{$record->id}}</a></td>
                                        <td><a href="/sizes/{{$record->id}}/edit">{{$record->name}}</a></td>
