    ...
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="/backend-tournaments">Dashboard</a>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example" >
                            ...
                            <tbody>
                                ...
                                @foreach ($records as $record)
                                    ...
                                    <tr class="gradeX">
                                        <td><a href="/tournament-registration/{{$record->id}}">{{$record->id}}</a></td>
                                        <td><a href="/tournament-registration/{{$record->id}}">{{$record->fullname}}</a></td>
