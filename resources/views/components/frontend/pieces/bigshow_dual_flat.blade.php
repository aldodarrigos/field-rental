    ...
    <div class="flex flex-col md:flex-row mb-6 bg-{{$bg}} rounded-lg">
        <div class="w-2/2 md:w-1/2">
            <img class="object-cover w-full h-full rounded-t-lg md:rounded-l-lg md:rounded-t-none" src="{{$image}}" alt="">
        </div>
    ...
    @else
        <div class="flex flex-col-reverse md:flex-row mb-6 bg-{{$bg}} rounded-lg">
            ...
            <div class="w-2/2 md:w-1/2">
                <img class="object-cover w-full h-full rounded-t-lg md:rounded-r-lg md:rounded-tl-none" src="{{$image}}" alt="">
            </div>
        </div>
