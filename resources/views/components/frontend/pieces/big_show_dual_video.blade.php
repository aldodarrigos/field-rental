<div class="flex rounded-lg flex-col md:flex-row">
    ...
    <div class="w-5/5 md:w-2/5 bg-{{$bg}} text-white px-10 md:px-20 py-16 rounded-b-lg md:rounded-bl-none md:rounded-r-lg">
        ...
        <x-frontend.buttons.calltoaction link='/' size='regular'>{{$link_text}} <i class="fas fa-caret-right"></i></x-frontend.buttons.calltoaction>
    </div>
</div>