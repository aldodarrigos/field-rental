    ...
    <div class="bg-blue text-white px-10 py-7 rounded-lg min-h-400p">
        ...
        <div class="">
            ...
            <div class="grid grid-cols-3 mb-4">
                <div class="">
                    <div class="font-roboto text-lg uppercase font-bold leading-none mb-2 mt-2">Team name</div>
                    <div class="font-roboto text-xl uppercase font-bold leading-none mb-2 mt-2 text-warning">{{$team_name}}</div>
                </div>
                <div class="">
                    <div class="font-roboto text-lg uppercase font-bold leading-none mb-2 mt-2">Category</div>
                    <div class="font-roboto text-xl uppercase font-bold leading-none mb-2 mt-2 text-warning">{{$category}}</div>
                </div>
                <div class="">
