<div class="rounded-lg">
    ...
    <div class="bg-blue text-white px-10 py-7 rounded-lg min-h-400p">
        ...
        <div class="">
            ...
            <h2 class="text-info font-roboto text-4xl uppercase font-bold leading-none mt-2">Successful purchase</h2>
            <div class="grid grid-cols-3 mb-4">
                <div class="">
                    <div class="font-roboto text-lg uppercase font-bold leading-none mb-2 mt-2">Size</div>
                    <div class="font-roboto text-xl uppercase font-bold leading-none mb-2 mt-2 text-warning">{{$size}}</div>
                </div>
                <div class="">
                    <div class="font-roboto text-lg uppercase font-bold leading-none mb-2 mt-2">Quantity</div>
                    <div class="font-roboto text-xl uppercase font-bold leading-none mb-2 mt-2 text-warning">{{$quantity}}</div>
                </div>
                <div class="">
            ...
            <div class="mt-4">
                <div class="font-roboto text-lg uppercase font-bold leading-none mb-2 mt-2">Order Code</div>
