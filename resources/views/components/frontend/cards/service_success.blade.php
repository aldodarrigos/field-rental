<div class="rounded-lg">
    ...
    <div class="bg-blue text-white px-10 py-7 rounded-lg min-h-400p">
        ...
        <div class="">
            ...
            <div class="mt-4">
                <div class="font-roboto text-lg uppercase font-bold leading-none mb-2 mt-2">Player name</div>
                <div class="font-roboto text-xl uppercase font-bold leading-none mb-2 mt-2 text-warning">{{$player_name}}</div>
            </div>
