                            ...
                            <tr>
                                <td>
                                    <div class="text" style="padding: 0 2.5em; text-align: center;">
                                        ...
                                        <p><Strong>Price:</Strong> ${{$reservation->final_price}}</p>
                                        ...
                                        @foreach ($players as $player)
                                            ...
                                            @php
                                                $grade = ($reservation->service_id == 7)?'Grade: '.$player->grade.' / ':'';
                                                $gender = ($player->gender == 1)?'Female':'Male';
                                            @endphp
            
                                            <p><Strong>{{$player->name}} /</Strong> Age:{{$player->age}} / Gender:{{$gender}} / {{$grade}} Tshirt Size: {{$player->tshirt_size}}</p>
                                        @endforeach
