    ...
    <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div class="col-span-6">
            ...
            <x-frontend.cards.field_booking>
                ...
                <x-slot name='title'>Allianz Arena (2020-12-24)</x-slot>
                <x-slot name='title_color'>white</x-slot>

                <x-slot name='sumary'>

                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Reprehe, vitae. Voluptas nobis neque veritatis ut!</p>
                    ...
                    <div class="inline-flex flex-wrap gap-2">
                        ...
                        <x-frontend.buttons.no_link>
                            ...
                            <x-slot name='class'>dummyclass</x-slot>
                            <x-slot name='id'>dummy_id</x-slot>
                            <x-slot name='pointer'>off</x-slot>
