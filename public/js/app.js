...
__webpack_require__(/*! ./mapkick */ "./resources/js/mapkick.js");
...
(function (global, factory) {
  ...
  function createMarkerImage(library, color) {
    ...
    var height = 41;
    var width = 27;
    var scale = 2; // get marker svg

    var svg = new library.Marker()._element.querySelector("svg"); // make displayable and center vertically
    ...
    validateColor(color); // set color

    svg.querySelector("*[fill='#3FB1CE']").setAttribute("fill", color); // add border to inner circle
    ...
    circle.setAttribute("r", 4.5); // create image
  ...
  var BaseMap = function BaseMap(element, data, options, mapType) {
    ...
    function generateLabelGeoJSON(data) {
      ...
      for (var i = 0; i < data.features.length; i++) {
        ...
        var coordinates = void 0; // use center for now
    ...
    function layerBeforeFill(map) {
      ...
      for (var i = layers.length - 1; i >= 0; i--) {
        var layer = layers[i]; // TODO improve
    ...
    function addLayer(name, geojson) {
      ...
      var popup = new library.Popup(popupOptions); // ensure tooltip is visible
      ...
      var panMap = function panMap(map, popup) {
        ...
        var extra = 5;
        var top = matrix.m42;
        var left = matrix.m41; // TODO add right and bottom
      ...
      var showPopup = function showPopup(e) {
        ...
        popup.addTo(map); // fix blurriness for non-retina screens
      ...
      var selectedFeature = function selectedFeature(e) {
        ...
        for (var i = 1; i < features.length; i++) {
          var feature = features[i]; // no need to handle ties since this is stable
  ...
  if (typeof window !== "undefined" && !window.Mapkick) {
    window.Mapkick = Mapkick; // use setTimeout so mapping library can come later in same JS file
...
__webpack_require__(/*! /Applications/XAMPP/xamppfiles/htdocs/KATYA/katyisc/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Applications/XAMPP/xamppfiles/htdocs/KATYA/katyisc/resources/css/app.css */"./resources/css/app.css");
